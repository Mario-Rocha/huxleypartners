...
export default function LiberacionDeResponsabilidad() {
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <AnimatedSection>
            ...
            <h1 className="font-[family-name:var(--font-display)] text-4xl md:text-5xl font-bold text-white mb-6">
              {content?.title || "Liberación de Responsabilidad"}
            </h1>
          </AnimatedSection>
        </div>
      </section>
          ...
          <AnimatedSection>
            {content?.body ? (
              ...
              <p className="text-sm text-text-light italic text-center py-16">
                El aviso de liberación de responsabilidad está siendo preparado. Por favor visite esta página más tarde.
              </p>
            )}
          </AnimatedSection>
        </div>
