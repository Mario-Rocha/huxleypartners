        ...
        <div className="max-w-5xl mx-auto px-6 lg:px-8">
          <AnimatedSection>
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                <h3 className="text-xl font-bold text-primary-dark">Huxley Partners on LinkedIn</h3>
                <p className="text-sm text-text-light">Follow us for the latest updates</p>
              </div>
            </div>
          </AnimatedSection>
              ...
              <div className="flex flex-col md:flex-row items-center gap-8">
                <div className="flex-1">
                  <p className="text-text-light leading-relaxed mb-6">
                    Stay up to date with our publications, articles, and news from the legal world. We share analysis, trends, and perspectives on the most relevant topics for your business.
                  </p>
